...
<div class="row">
	<div class="col-sm-10">
		<div class="jumbotron">
		  ...
		  <p>Website jasa pembuatan aplikasi dekstop dan web</p>
		  <p><a class="btn btn-primary btn-lg" href="#" role="button" onclick="document.getElementById('id02').style.display='block'" style="width:auto;">Register Now</a></p>
		</div>
   ...
   <?php
     ...
     <div class="col-sm-4 col-md-2">
        <div class="thumbnail" style="height: 370px;">
          <img src="images/<?php echo $d['img'];?>" alt="" name="gbr">
          <div class="caption">
            <h5><?php echo $d['nama']; ?></h5>
            <p><?php echo $d['isi'];  ?></p>
            <input type="Hidden" name="id" value="<?=isset($_POST['id']) ? $d['id'] : ''?>">
            <p><a href="#?id=<?php echo $d['id'];?>" type="submit" name="submit" id="submit" onclick="document.getElementById('id04').style.display = 'block'" style="width:auto;display: block;" class="btn btn-large btn-block btn-primary" role="button">Pesan</a> <a href="#" class="btn btn-large btn-block btn-default" role="button" style="float: right;">Batal</a></p>
...
<div id="id04" class="modal">
  <form class="modal-content animate" action="pesan.php" method="post" style="width: 100%;">
    ...
    <div class="container" style="width: 100%;">
      ...
      <p style="text-align: center;"><img src="images/<?php echo $d['img'];?>" alt=""></p>
        <?php  
           $i++;  }
         ?>
