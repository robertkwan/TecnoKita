...
<div class="panel panel-default">
  <div class="panel-heading"><b><h3>Pengembangan untuk Aplikasi</b></h3></div>
  <div class="panel-body" style="padding-left: 0px;padding-right: 0px;">
    <div class="col-md-4">
      <img src="img/aplikasi.png" style="width: 100%;">
    </div>
    <div class="col-md-8">
       <h4 class="card-title" style="margin-top: 10px;"><p><b>Membantu pembuatan dan pengembangan website mulai dari website sederhana, menggunakan CMS, mobile friendly, EC-site, hingga sistem web yang memerlukan kemampuan teknis tinggi dalam pembuatannya.</b></h4></p>
      <p>Memberikan layanan pendaftaran aplikasi ke GooglePlay atau ke Apple Store bagi pelanggan yang belum bisa mendaftar sendiri,manajemen server website, pemeliharaan hingga pengoperasian sistem yang baik.</p>
      <h4 class="card-title">Kelebihan WebNoKita</h4>
       <ul >
         <li>Penguasaan Teknologi Berkualitas</li>
         <li style="text-align: justify;">Kinerja yang Baik, Pengembangan sistem backend</li>
         <li>Jaminan Kualitas, Harga Terjangkau</li>
         <li style="text-align: justify;">Kemampuan Desain yang Mampu memberikan saran tentang desain, gambar, maupun icon untuk interface di dalam aplikasi maupun website.</li>
         <li style="text-align: justify;">Dukungan multi bahasa Dalam mempromosikan suatu produk, keberadaan website maupun aplikasi dalam beragam bahasa akan sangat mendukung. Bagi Anda yang ingin aplikasi maupun web multi bahasa, kami dapat membantu Anda dalam mempersiapkan data dalam berbagai bahasa.</li>
       </ul>
      </p>
       <h4 class="card-title">Daftar Aplikasi Web & Dekstop </h4>
      <ul>
          <li style="text-align: justify;">
Aplikasi Navigasi berbasis web ini dikembangkan dengan memanfaatkan sistem GPS yang ada di dalam perangkat untuk memeroleh informasi lokasi pengguna serta penggunaan API dari Google.</li>
          <li style="text-align: justify;">Aplikasi Kantor berbasis dekstop,
Kami juga dapat mengembangkan aplikasi untuk meningkatkan efisiensi bisnis terutama di bagian perkantoran. Misalnya aplikasi untuk manajemen pelanggan, kartu nama, pembuatan file, manajemen jadwal dll.</li>
          <li style="text-align: justify;">Aplikasi Pariwisata berbasis web,
Aplikasi ini dapat digunakan untuk mengelola informasi wisata yang akan disuguhkan kepada masyarakat. Dilengkapi dengan peta, informasi daerah wisata menarik, push notifikasi, petunjuk arah dan lain-lain.</li>
          <li style="text-align: justify;">Aplikasi Pendidikan berbasis web, 
Tersedia juga aplikasi yang dapat mengedukasi seperti aplikasi untuk latihan menghafal, percakapan bahasa Inggris dan lain-lain yang dapat diperbarui secara real time.</li>
