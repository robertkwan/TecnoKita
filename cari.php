   ...
   <div class="col-sm-4 col-md-2">
    <div class="thumbnail" style="height: 370px;">
      ...
      <div class="caption">
        ...
        <p><?php echo $d['isi']; ?></p>
       <a href="#" onclick="document.getElementById('id04').style.display='block'" style="width:auto;" class="btn btn-large btn-block btn-primary" role="button">Pesan</a> <a href="#" class="btn btn-large btn-block btn-default" role="button" style="float: right;">Batal</a></p>
      </div>
    </div>
  </div>
  <?php } ?>
 ...
 <div class="col-sm-6">
    ...
    <div class="card-body">
      <div class="caption">
        ...
        <a href="#" class="btn btn-large btn-block btn-primary">Read more...</a>
      </div>
    </div>
  </div>
</div>
