...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: black">
      ...
      <li style="margin-top: 0px;"><a href="profile.php?username=<?php echo $_GET['username'];?>" style="text-decoration: none;"><img src="img/<?php echo $_GET['nama_file'];?>" style="width: 30px;height: 30px;margin-right: 5px;border-radius: 20px;"><?php echo $_GET['username'];?></a></li>
...
<div class="row">
  ...
  if(isset($_GET['nama'])){
    $cari = $_GET['nama'];
    $data = mysqli_query($con, "select * from list where nama like '%".$cari."%' or isi like '%".$cari."%'");       
  }
   ...
   <div class="col-sm-4 col-md-2">
    <div class="thumbnail">
      ...
      <div class="caption">
        ...
        <p><?php echo $d['isi']; ?></p>
        <p><a href="#" class="btn btn-primary" role="button" data-toggle="modal" data-target="#myModal">Pesan</a> <a href="#" class="btn btn-default" role="button" style="float: right;">Batal</a></p>
      </div>
    </div>
  </div>
  <?php } ?>
