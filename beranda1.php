...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: black">
      ...
      <li style="margin-top: 0px;"><a href="profile.php?username=<?php echo $_GET['username'];?>" style="text-decoration: none;"> <img src="http://ssl.gstatic.com/accounts/ui/avatar_2x.png" style="width: 30px;height: 30px;margin-right: 5px;border-radius: 20px;"><?php echo $_GET['username'];?></a></li>
