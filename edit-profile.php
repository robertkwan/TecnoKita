...
//bentuk sql query untuk update  
    $update = "update foto set first_name='".$_POST['first_name']."', last_name='".$_POST['last_name']."', phone='".$_POST['phone']."', mobile='".$_POST['mobile']."', email='".$_POST['email']."', location='".$_POST['location']."', hobby='".$_POST['hobby']."', alamat='".$_POST['alamat']."' ";  
    if($_FILES['file']['size'] > 0 && $_FILES['file']['error'] == 0){ //update gambar hanya jika user memilih file baru  
        $move = move_uploaded_file($_FILES['file']['tmp_name'], "img/".$_FILES['file']['name']);  
        if($move){  
            $update .= ", nama_file='".$_FILES['file']['name']."'";  
        }  
    }  
    $update .= " where id='".$_POST['id']."'";  
    mysqli_query($con, $update); //update data ke database  
...
<nav class="navbar navbar-inverse navbar-static-top" role="navigation">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="background-color: black">
      ...
      <ul class="nav navbar-nav navbar-right" style="margin-top: 5px;">
       <form class="navbar-form navbar-left" name="form1" method="post" action="upload.php" enctype="multipart/form-data">
     ...
     <?php  
                ...
                <li style="margin-top: 0px;"><a href="#"> <img src="img/<?php echo $data['nama_file'];?>" style="width: 30px;height: 30px;margin-right: 5px;border-radius: 20px;"><?php echo $data['first_name'];?></a></li>
          
		<li><a href="beranda1.php?username=<?php echo $data['first_name'];?>">Home</a></li>
...
<div class="row">
    ...
    <div class="row">
  		<div class="col-sm-10"><h1><?php echo $data['first_name']?></h1></div>
      ...
      <div class="text-center">
        <img src="img/<?php echo $data['nama_file'];?>" class="avatar img-circle img-thumbnail" alt="avatar" style="width: 200px;height: 200px;">
        ...
        <input type="file" class="text-center center-block file-upload" name="file" id="file"/>
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-body"><a href="http://jasapembuatanaplikasi.com">jasapembuatanaplikasi.com</a></div>
          </div>
                  ...
                  <form class="form" action="#" method="post" id="registrationForm">
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="first_name" id="first_name" placeholder="first name" value="<?php echo $data['first_name'];?>" title="enter your first name if any.">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="last_name"><h4>Last name</h4></label>
                              <input type="text" class="form-control" name="last_name" id="last_name" placeholder="last name" value="<?php echo $data['last_name'];?>"title="enter your last name if any.">
                          </div>
                      </div>
                      ...
                      <div class="form-group">
                          <div class="col-xs-6">
                             <label for="mobile"><h4>Mobile</h4></label>
                              <input type="text" class="form-control" name="mobile" id="mobile" placeholder="enter mobile number" value="<?php echo $data['mobile'];?>" title="enter your mobile number if any.">
                          </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="email" class="form-control" name="location" id="location" placeholder="somewhere" value="<?php echo $data['location'];?>"title="enter a location">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                              ...
                              <input type="text" class="form-control" name="hobby" id="hobby" placeholder="Hobby" value="<?php echo $data['hobby'];?>" title="enter your hobby.">
                          </div>
                      </div>
                      <div class="form-group">
                          ...
                          <div class="col-xs-6">
                            <label for="alamat"><h4>Alamat</h4></label>
                              <input type="text" class="form-control" name="alamat" id="alamat" placeholder="Alamat" value="<?php echo $data['alamat'];?>" title="enter your street.">
                          </div>
                      </div>
                      <div class="form-group">
                           <div class="col-xs-12">
                                <br>
                                <button class="btn btn-lg btn-success" type="submit" name="save"><i class="glyphicon glyphicon-ok-sign"></i>Upload</button>     
...
<div class="card mb-3">
  <img class="card-img-top" src="img/dektop.png" alt="Card image cap">
  <div class="card-body">
...
<footer id="myFooter">
        <div class="container" style="width: 80%">
            <div class="row" style="width: 70%">
                ...
                <div class="col-sm-3 info">
                    ...
                    <p>Contact: robetkwan@gmail.com</p>
        ...
        <div class="second-bar">
           <div class="container">
                <h2 class="logo"><a href="#"><img src="images/logo.jpg" style="width: 50px;height: 50px;border-radius: 30px;"> Jasa Pembuatan Aplikasi </a></h2>
